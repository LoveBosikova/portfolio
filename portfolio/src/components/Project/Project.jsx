        ...
        <article className="project">
            <div className="project__wrap">
                ...
                <div className="project__textSide">
                    ...
                    <div className="links">
                        <a className="links__item links__item--code" target="_blank" href="https://github.com/stefvndev/Gymate" rel="noreferrer">
                        ...
                        <a className="links__item links__item--demo" target="_blank" href="https://gymate-iota.vercel.app/" rel="noreferrer">
