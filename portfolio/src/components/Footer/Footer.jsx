        ...
        <section className="footer">
            <div className="footer__wrap">
                ...
                <div className="footer__contacts">
                    ...
                    <a href="" className="footer__iconWrap">
                        <svg className="footer__icon footer__icon--git" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" strokeLinecap="round" strokeLinejoin="round">
